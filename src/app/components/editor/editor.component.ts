...
import { CutDirective } from 'src/app/directives/cut.directive'
import { PasteDirective } from 'src/app/directives/paste.directive'
...
@Component({
	selector: 'app-editor',
	standalone: true,
	imports: [CommonModule, MatDialogModule, MatButtonModule, FormsModule, CopyDirective, CutDirective, PasteDirective],
