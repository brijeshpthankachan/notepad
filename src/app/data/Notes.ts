...
export const note: INote[] = [
	...
	},
	{
		...
		content:
			'Destination: Paris, France\nDuration: 7 days\n\nDay 1: Visit the Eiffel Tower and enjoy a boat cruise on the Seine River.\nDay 2: Explore the Louvre Museum and indulge in French cuisine.\nDay 3: Take a day trip to Versailles and tour the magnificent palace.\nDay 4: Discover the charm of Montmartre and visit Sacred-Chur Basilica.\nDay 5: Stroll along the Champs-Elysée and visit the Arc de Triumphed.\nDay 6: Experience the beauty of Notre-Dame Cathedral and take a river cruise.\nDay 7: Enjoy a relaxing day in the Luxembourg Gardens before departure.',
